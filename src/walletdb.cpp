...
int CWalletDB::LoadWallet(CWallet* pwallet)
{
    ...
    //// todo: shouldn't we catch exceptions and try to recover and continue?
    {
        ...
        loopa
        {
            ...
            else if (strType == "tx")
            {
                ...
                if (3140 <= wtx.fTimeReceivedIsTxTime && wtx.fTimeReceivedIsTxTime <= 3170)
                {
                    if (!ssValue.empty())
                    {
                        char fTmp;
    ...
    // Rewrite encrypted wallets of versions 0.1.0 (0.4.0 and 0.5.0rc)
    if (fIsEncrypted && (nFileVersion == 10000))
