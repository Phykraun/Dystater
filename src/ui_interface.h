...
#ifndef DYSTATER_UI_INTERFACE_H
#define DYSTATER_UI_INTERFACE_H
...
/* These UI communication functions are implemented in dystater.cpp (for ui) and noui.cpp (no ui) */
