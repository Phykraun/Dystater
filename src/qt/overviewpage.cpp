...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(DystaterUnits::DYST)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = DystaterUnits::formatWithUnit(unit, amount, true);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(qint64 balance, qint64 unconfirmedBalance)
{
    ...
    ui->labelUnconfirmed->setText(DystaterUnits::formatWithUnit(unit, unconfirmedBalance));
}
