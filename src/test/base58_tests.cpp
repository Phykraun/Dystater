...
// CDystaterAddress
    ...
    // bool IsValid() const
    // CDystaterAddress()
    // CDystaterAddress(uint160 hash160In)
    // CDystaterAddress(const std::vector<unsigned char>& vchPubKey)
    // CDystaterAddress(const std::string& strAddress)
    // CDystaterAddress(const char* pszAddress)
